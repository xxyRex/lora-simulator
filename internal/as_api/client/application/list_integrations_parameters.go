...
// WithID adds the id to the list integrations params
func (o *ListIntegrationsParams) WithID(id string) *ListIntegrationsParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the list integrations params
func (o *ListIntegrationsParams) SetID(id string) {
	o.ID = id
}
