...
func (o *ImportReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /api/payloadcodecs-import] Import", response, response.Code())
	}
}
...
func (o *ImportOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/payloadcodecs-import][%d] importOK %s", 200, payload)
}
...
func (o *ImportOK) GetPayload() *models.APIImportPayloadCodecResponse {
	return o.Payload
}
