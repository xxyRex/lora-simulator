...
// WithDevEUI adds the devEUI to the get device params
func (o *GetDeviceParams) WithDevEUI(devEUI string) *GetDeviceParams {
	o.SetDevEUI(devEUI)
	return o
}

// SetDevEUI adds the devEUi to the get device params
func (o *GetDeviceParams) SetDevEUI(devEUI string) {
	o.DevEUI = devEUI
}
