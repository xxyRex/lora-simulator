...
func (o *UpdateParams) WithBody(body *models.APIUpdatePacketForwardRequest) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.APIUpdatePacketForwardRequest) {
	o.Body = body
}
