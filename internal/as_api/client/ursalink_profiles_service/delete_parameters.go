...
// WithProfileID adds the profileID to the delete params
func (o *DeleteParams) WithProfileID(profileID string) *DeleteParams {
	o.SetProfileID(profileID)
	return o
}

// SetProfileID adds the profileId to the delete params
func (o *DeleteParams) SetProfileID(profileID string) {
