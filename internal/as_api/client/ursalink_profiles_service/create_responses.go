...
func (o *CreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /api/urprofiles] Create", response, response.Code())
	}
}
...
func (o *CreateOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/urprofiles][%d] createOK %s", 200, payload)
}
...
func (o *CreateOK) GetPayload() *models.APICreateProfileResponse {
	return o.Payload
}
