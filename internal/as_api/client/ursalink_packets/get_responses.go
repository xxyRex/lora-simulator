...
func (o *GetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /api/urpackets] Get", response, response.Code())
	}
}
...
func (o *GetOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/urpackets][%d] getOK %s", 200, payload)
}
...
func (o *GetOK) GetPayload() *models.APIUrGetPacketsResponse {
	return o.Payload
}
