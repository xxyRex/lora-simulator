...
// WithDevEUI adds the devEUI to the get keys params
func (o *GetKeysParams) WithDevEUI(devEUI string) *GetKeysParams {
	o.SetDevEUI(devEUI)
	return o
}

// SetDevEUI adds the devEUi to the get keys params
func (o *GetKeysParams) SetDevEUI(devEUI string) {
	o.DevEUI = devEUI
}
