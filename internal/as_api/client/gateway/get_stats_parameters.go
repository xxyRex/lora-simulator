...
// WithEndTimestamp adds the endTimestamp to the get stats params
func (o *GetStatsParams) WithEndTimestamp(endTimestamp *string) *GetStatsParams {
	o.SetEndTimestamp(endTimestamp)
	return o
}

// SetEndTimestamp adds the endTimestamp to the get stats params
func (o *GetStatsParams) SetEndTimestamp(endTimestamp *string) {
	o.EndTimestamp = endTimestamp
}

// WithInterval adds the interval to the get stats params
func (o *GetStatsParams) WithInterval(interval *string) *GetStatsParams {
	o.SetInterval(interval)
	return o
}

// SetInterval adds the interval to the get stats params
func (o *GetStatsParams) SetInterval(interval *string) {
	o.Interval = interval
}

// WithMac adds the mac to the get stats params
func (o *GetStatsParams) WithMac(mac string) *GetStatsParams {
	o.SetMac(mac)
	return o
}

// SetMac adds the mac to the get stats params
func (o *GetStatsParams) SetMac(mac string) {
	o.Mac = mac
}

// WithStartTimestamp adds the startTimestamp to the get stats params
func (o *GetStatsParams) WithStartTimestamp(startTimestamp *string) *GetStatsParams {
	o.SetStartTimestamp(startTimestamp)
	return o
}

// SetStartTimestamp adds the startTimestamp to the get stats params
func (o *GetStatsParams) SetStartTimestamp(startTimestamp *string) {
