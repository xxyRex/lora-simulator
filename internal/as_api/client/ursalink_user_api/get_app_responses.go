...
func (o *GetAppReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /api/applications/{name}] GetApp", response, response.Code())
	}
}
...
func (o *GetAppOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/applications/{name}][%d] getAppOK %s", 200, payload)
}
...
func (o *GetAppOK) GetPayload() *models.APIUrGetAppResponse {
	return o.Payload
}
