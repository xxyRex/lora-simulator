...
func (o *ListUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /api/organizations/{id}/users] ListUsers", response, response.Code())
	}
}
...
func (o *ListUsersOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/organizations/{id}/users][%d] listUsersOK %s", 200, payload)
}
...
func (o *ListUsersOK) GetPayload() *models.APIListOrganizationUsersResponse {
	return o.Payload
}
