...
func (o *UpdateUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /api/organizations/{id}/users/{userID}] UpdateUser", response, response.Code())
	}
}
...
func (o *UpdateUserOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/organizations/{id}/users/{userID}][%d] updateUserOK %s", 200, payload)
}
...
func (o *UpdateUserOK) GetPayload() models.APIOrganizationEmptyResponse {
	return o.Payload
}
