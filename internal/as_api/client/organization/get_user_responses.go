...
func (o *GetUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /api/organizations/{id}/users/{userID}] GetUser", response, response.Code())
	}
}
...
func (o *GetUserOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/organizations/{id}/users/{userID}][%d] getUserOK %s", 200, payload)
}
...
func (o *GetUserOK) GetPayload() *models.APIGetOrganizationUserResponse {
	return o.Payload
}
