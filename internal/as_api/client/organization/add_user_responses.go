...
func (o *AddUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /api/organizations/{id}/users] AddUser", response, response.Code())
	}
}
...
func (o *AddUserOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/organizations/{id}/users][%d] addUserOK %s", 200, payload)
}
...
func (o *AddUserOK) GetPayload() models.APIOrganizationEmptyResponse {
	return o.Payload
}
