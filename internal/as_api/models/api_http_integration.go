...
type APIHTTPIntegration struct {
	...
	Headers []*APIHTTPIntegrationHeader `json:"headers"`
...
func (m *APIHTTPIntegration) validateHeaders(formats strfmt.Registry) error {
...
func (m *APIHTTPIntegration) contextValidateHeaders(ctx context.Context, formats strfmt.Registry) error {
